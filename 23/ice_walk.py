...
def part_one(f):
    return walk((1, 0), file_to_array(f))
...
assert_equals(walk((1, 0), file_to_array(TEST_INPUT)), 94)
assert_equals(walk((1, 0), file_to_array(TEST_INPUT), False), 154)


start = time.time()
print("Part One: ", walk((1, 0), file_to_array(INPUT)))
